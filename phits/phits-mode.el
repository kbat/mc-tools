...
(define-generic-mode 'phits-mode
  ...
  '(
    ("^[Cc].*" . 'font-lock-comment-face)    ;; a "c" followed by a blank in
     ...
     ("\\<\\(area\\|a-curr\\|chart\\|color\\|current\\|deposit\\|dchain\\|dpa\\|eng\\|gshow\\|heat\\|imp\\|flux\\|[mM]t?[0-9]\\{1,4\\}\\|name\\|nucleus\\|off\\|q\\|qp\\|reg\\|r-in\\|r-out\\|rpp\\|r-z\\|set\\|size\\|source\\|t\\|tmp\\|tr.\\|tr..\\|vol\\|[xyz][xyz]?[xyz]?\\)\\>" . 'font-lock-keyword-face) ;; phits keywords
