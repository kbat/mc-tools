...
(define-generic-mode 'phits-mode
  ...
  '(
    ("^[Cc].*" . 'font-lock-comment-face)    ;; a "c" followed by a blank in
     ...
     ("^ \\{0,4\\}\\[\\<\\(cell\\|end\\|importance\\|material\\|parameters\\|mat name color\\|source\\|surface\\|t-3dshow\\|t-heat\\|t-dpa\\|t-deposit2?\\|t-gshow\\|timer\\|title\\|t-cross\\|t-product\\|t-track\\|t-yield\\|temperature\\|transform\\|volume\\)\\>\\] ?.*" . 'font-lock-section-face) ;; ?.* in the end mean that we color also the section title (if any)
     ("^ *\\<\\(angel\\|[aelrstxyz]-type\\|axis\\|box\\|dir\\|deltm\\|dmax\\|dose\\|e0\\|edel\\|[el]-dst\\|ejamnu\\|[el]-phi\\|epsout\\|[el]-the\\|eqmdmin\\|eqmdnu\\|factor\\|file\\|[rg]-show\\|heaven\\|icntl\\|icput\\|icrhi\\|ielas\\|igamma\\|igchk\\|igcut\\|imout\\|incut\\|info\\|inmed\\|inucr\\|ipreeq\\|isobar\\|itall\\|level\\|line\\|mat\\|ndata\\|nedisp\\|nevap\\|nlost\\|nspred\\|material\\|maxbch\\|maxcas\\|mesh\\|multiplier\\|n[aertxyz]\\|output\\|part\\|pnint\\|product\\|proj\\|r0\\|reg\\|resol\\|rseed\\|shadow\\|source\\|title\\|tmin\\|tmax\\|trcl\\|t[dnw]\\|unit\\|w-dst\\|w-hgt\\|width\\|w-wdt\\|[aerxyz]\\(max\\|min\\)\\|[xyz]\\([01]\\|max\\|min\\|-txt\\)\\|[xyz][xyz]\\)\\>" . 'font-lock-parameter-face) ;; note that there must be no other symbols (except space) before parameter
