...
(setq fluka-font-lock-keywords
      (let* (
		...
		"SODIUM" "STERNHEI" "SULFUR" "TANTALUM" "TIN" "TITANIUM" "TSL-PWXS" "TUNGSTEN" "VACUUM" "VANADIUM" "WATER" "YTTRIUM" "ZINC"))
	     ...
	     (particles
	      '("4-HELIUM" "ALL-PART" "ANNIHRST" "BEAMPART" "DOSAVLET" "DOSE" "DOSE-EQ" "DPA-SCO" "E+&E-" "E+E-GAMM" "ELECTRON" "EM-ENRGY" "ENERGY" "HAD-CHAR" "HEAVYION" "HVY-IONS" "ISOTOPE"  "LGH-IONS" "MUONS" "MUON+" "MUON-" "NEUTRON" "OPTIPHOT" "PIONS+-" "POSITRON" "PHOTON" "PROTON" "ALPHA-D" "SQBETA-D"))
	     (fluence2dose
