...
(setq fluka-font-lock-keywords
      (let* (
	     ...
	     (keywords
	     '("BEAMSPOT" "BIASING" "BIOTOBIN" "BME" "DPMJET" "D-D" "D-T" "CHARMDEC" "EXPTRANS" "GCR-SPE" "GCR-IONF" "GCR-AMS" "MYRQMD" "OPEN" "RQMD" "SOURCE" "SPECSOUR" "SPOTBEAM" "SPOTDIR" "SPOTPOS" "SPOTPOS" "SPORTRAN" "ERDUMP" "USRGCALL" "USRICALL"
	     ...
	     "POLARIZA" "PROD-CUT" "QUASI-EL" "QMDTHRES" "RAD-BIOL" "STEPSIZE" "THRESHOL" "TIME-CUT"  "NEW" "OLD" "UNKNOWN" "USER" "SCRATCH" "INEPRI"))
	     (surfaces
		...
		"SODIUM" "STERNHEI" "SULFUR" "TANTALUM" "TIN" "TITANIUM" "TSL-PWXS" "TUNGSTEN" "VACUUM" "VANADIUM" "WATER" "ZINC"))
	     ...
	     (particles
	      '("4-HELIUM" "ALL-PART" "ANNIHRST" "BEAMPART" "DOSAVLET" "DOSE" "DOSE-EQ" "DPA-SCO" "E+E-GAMM" "ELECTRON" "EM-ENRGY" "ENERGY" "HEAVYION" "HVY-IONS" "ISOTOPE" "LASTPAR" "LGH-IONS" "MUONS" "MUON+" "MUON-" "NEUTRON" "OPTIPHOT" "POSITRON" "PIONS" "PHOTON" "PROTON", "ALPHA-D", "SQBETA-D"))
	     (fluence2dose
