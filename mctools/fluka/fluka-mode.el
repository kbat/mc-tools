...
(setq fluka-font-lock-keywords
      (let* (
		...
		"SODIUM" "STERNHEI" "SULFUR" "TANTALUM" "TIN" "TITANIUM" "TSL-PWXS" "TUNGSTEN" "VACUUM" "VANADIUM" "WATER" "ZINC"))
	     ...
	     (particles
	      '("4-HELIUM" "ALL-PART" "ANNIHRST" "BEAMPART" "DOSE" "DOSE-EQ" "DPA-SCO" "E+E-GAMM" "ELECTRON" "EM-ENRGY" "ENERGY" "HEAVYION" "HVY-IONS" "ISOTOPE" "LASTPAR" "LGH-IONS" "MUONS" "MUON+" "MUON-" "NEUTRON" "OPTIPHOT" "POSITRON" "PIONS" "PHOTON" "PROTON"))
	     (fluence2dose
