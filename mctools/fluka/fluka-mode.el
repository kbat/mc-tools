...
(setq fluka-font-lock-keywords
      (let* (
	     ...
	     (keywords
	     '("BEAMSPOT" "BIASING" "BIOTOBIN" "BME" "DECAYS" "DPMJET" "DPA-ENER" "DPMTHRES" "D-D" "D-T" "CHARMDEC" "EXPTRANS" "GCR-SPE" "GCR-IONF" "GCR-AMS" "MYRQMD" "OPEN" "RQMD" "SOURCE" "SPECSOUR" "SPOTBEAM" "SPOTDIR" "SPOTPOS" "SPOTPOS" "SPORTRAN" "ERDUMP" "USRGCALL" "USRICALL"
		...
		"SODIUM" "STERNHEI" "SULFUR" "TANTALUM" "TIN" "TITANIUM" "TSL-PWXS" "TUNGSTEN" "VACUUM" "VANADIUM" "WATER" "ZINC"))
	     ...
	     (orig
	      '("BMAX-REG" "DELAYNEU" "INVCOMPT" "NIEL-PFN" "PWXSTEMP" "RUNGKUTT" "SYNCRAD" "SYNCROFF" "SYNCRON" "SYPRONLY" "N-REFLEC" "X-REFLEC"))
