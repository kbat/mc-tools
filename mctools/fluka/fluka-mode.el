...
(setq fluka-font-lock-keywords
      (let* (
	     ...
	     "POLARIZA" "PROD-CUT" "QUASI-EL" "QMDTHRES" "STEPSIZE" "THRESHOL" "TIME-CUT" "NEW" "OLD" "UNKNOWN" "SCRATCH" "INEPRI"))
	     (surfaces
	     ...
	     (tallies
	      ...
	      "USRTRACK" "USRYIELD"))
	     (materials
	      '("ALUMINIUM" "ARGON" "ASSIGNMA" "ASSIGNMAT" "BERYLLIU" "BLCKHOLE" "CALCIUM" "CARBON" "COMPOUND" "COPPER" "CORRFACT" "GRAPHITE" "GOLD" "HELIUM" "HYDROGEN" "IRON" "LEAD" "LOW-MAT" "LOW-PWXS" "MAGNESIU" "MATERIAL" "MAT-PROP" "MERCURY" "NICKEL" "NITROGEN" "OPT-PROP" "OXYGEN" "POLYETHY" "SILICON" "SILVER"
		"SODIUM" "STERNHEI" "TANTALUM" "TIN" "TITANIUM" "TSL-PWXS" "TUNGSTEN" "VACUUM" "WATER" "endfb8r0" "njendfb8r0"))
	     (defaults
	       '("CALORIME" "DAMAGE" "EET/TRAN" "EM-CASCA" "ICARUS" "HADROTHE" "NEUTRONS" "NEW-DEFA" "PRECISIO" "PRECISION" "SHIELDIN" "SHIELDING"))
	     (particles
	      '("4-HELIUM" "ALL-PART" "ANNIHRST" "BEAMPART" "DOSE-EQ" "ELECTRON" "ENERGY" "HEAVYION" "ISOTOPE" "MUONS" "MUON+" "MUON-" "NEUTRON"
