...
(define-generic-mode 'phits-mode
  ...
  '(
    ("^c.*" . 'font-lock-comment-face)    ;; a "c" followed by a blank in
     ...
     ("!.*" . 'font-lock-comment-face)
     ("^#.*" . 'font-lock-comment-face)
     ("^ \\{0,4\\}\\[\\<\\(anatally\\|cell\\|end\\|importance\\|material\\|parameters\\|mat name color\\|reg name\\|source\\|surface\\|t-3dshow\\|t-heat\\|t-dpa\\|t-deposit2?\\|t-gshow\\|timer\\|title\\|t-cross\\|t-product\\|t-track\\|t-yield\\|temperature\\|transform\\|volume\\)\\>\\] ?.*" . 'font-lock-section-face) ;; ?.* in the end mean that we color also the section title (if any)

     ("^ *\\<\\(2d-type\\|amp\\|angel\\|[aelrstxyz]-type\\|axis\\|box\\|e-mode\\|dir\\|deltm\\|dmax\\|dom\\|dose\\|e0\\|edel\\|[el]-dst\\|ejamnu\\|[el]-phi\\|epsout\\|[el]-the\\|eqmdmin\\|eqmdnu\\|factor\\|file\\|[rg]-show\\|heaven\\|icntl\\|icommat\\|icput\\|icrhi\\|icxsni\\|ielas\\|igamma\\|igchk\\|igcut\\|imout\\|imuint\\|inclg\\|incut\\|infl\\|info\\|inmed\\|ipnint\\|inucr\\|ipreeq\\|ireschk\\|ismm\\|isobar\\|itall\\|jmout\\|level\\|line\\|mat\\|material\\|maxbch\\|maxcas\\|mesh\\|mirror\\|multiplier\\|n[aertxyz]\\|ndata\\|nedisp\\|negs\\|nevap\\|nlost\\|nspred\\|nucdata\\|output\\|outtime\\|part\\|pnint\\|product\\|proj\\|r0\\|reg\\|resol\\|rseed\\|shadow\\|source\\|timeevo\\|title\\|tmin\\|tmax\\|totfact\\|trcl\\|t[dnw]\\|unit\\|w-ang\\|w-dst\\|w-hgt\\|w-mn[hw]\\|w-wdt\\|width\\|[aerxyz]\\(max\\|min\\)\\|[xyz]\\([01]\\|max\\|min\\|-txt\\)\\|[xyz][xyz]\\)\\>" . 'font-lock-parameter-face) ;; note that there must be no other symbols (except space) before parameter
     ("\\<\\(area\\|a-curr\\|chart\\|color\\|current\\|deposit\\|dchain\\|dose\\|dpa\\|eng\\|gshow\\|heat\\|imp\\|flux\\|[mM]t?[0-9]\\{1,4\\}\\|name\\|non\\|nucleus\\|off\\|q\\|qp\\|reg\\|r-from\\|r-in\\|r-out\\|rpp\\|r-to\\|r-z\\|set\\|size\\|source\\|t\\|tmp\\|vol\\|[xyz][xyz]?[xyz]?\\)\\>" . 'font-lock-keyword-face) ;; phits keywords
