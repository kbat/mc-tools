...
* If the [GNU parallel](https://www.gnu.org/software/parallel) tool is installed then the ROOT converters called by the ```fluka2root``` script will be executed in parallel which makes it run faster.
